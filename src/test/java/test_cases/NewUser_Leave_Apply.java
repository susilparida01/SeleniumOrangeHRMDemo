...
public class NewUser_Leave_Apply {
	...
	@Test
	public void newUser_LeaveApply() throws Exception {
		...
		final String fname = "Hiroki";
		final String lname = "Totoki";
		final String newempUsername = "hiroki_totoki";
		final String newempPassword = "hiroki_totoki123";
...
//-------------------------------------------------------------------------------------------------------		
		...
		entitle_menu.add_leave_entitle_empname.sendKeys("Hiroki");
			for (WebElement addleave_empname_list : entitle_menu.add_leave_entitle_empname_list) {
				String addleave_empname_dd = addleave_empname_list.getText();
					if (addleave_empname_dd.equals("Hiroki Totoki")) {
